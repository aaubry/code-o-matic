...
// SelectorScanner
//-----------------------------------------------------------------------------------
internal class SelectorScanner {
	const char EOL = '\n';
	...
	static SelectorScanner() {
		start = new Hashtable(128);
		for (int i = 45; i <= 45; ++i) start[i] = 1;
		for (int i = 48; i <= 57; ++i) start[i] = 1;
		for (int i = 95; i <= 95; ++i) start[i] = 1;
		for (int i = 97; i <= 122; ++i) start[i] = 1;
		for (int i = 42; i <= 42; ++i) start[i] = 2;
		for (int i = 46; i <= 46; ++i) start[i] = 3;
		for (int i = 44; i <= 44; ++i) start[i] = 4;
		start[Buffer.EOF] = -1;

	}
	
	public SelectorScanner (string fileName) {
		try {
	...
	public SelectorScanner (Stream s) {
